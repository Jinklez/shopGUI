...
public class ClothingDetails extends JDialog {
	...
	public static void display(ShopController c, Clothing p){
		ClothingDetails dialog = new ClothingDetails(c, p);
		dialog.setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
		dialog.setLocationRelativeTo(c.getWindow());
		dialog.setVisible(true);
	}

	public ClothingDetails(ShopController c, Clothing p) {
