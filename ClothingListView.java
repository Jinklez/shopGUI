...
public class ClothingListView extends View {
	...
	public void initialize() {
		...
		List<Clothing> list = getController().getBackend().getClothing();
		for(Clothing p : list){
			scrollPanel.add(new ClothingThumbnail(getController(), p));
		}
		revalidate();
	}
